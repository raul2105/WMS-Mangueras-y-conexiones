...
export default function InventoryError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-xl mx-auto mt-12 glass-card border border-red-500/30 space-y-4 text-center">
      ...
      <h2 className="text-xl font-bold text-red-300">Error en Inventario</h2>
      <p className="text-slate-400 text-sm">{error.message || "Ocurrió un error inesperado al cargar el inventario."}</p>
