...
function usage() {
  return [
    ...
    "",
    "Usage:",
    "  node scripts/link-product-images-from-folder.cjs --dir public/uploads/products",
    "  node scripts/link-product-images-from-folder.cjs --dir public/uploads/products --dry-run",
    "",
    "Rules:",
