...
const ROLE_USERS: Record<RoleCode, { email: string; name: string; password: string }> = {
  SYSTEM_ADMIN: { email: "test-admin@scmayer.local", name: "Test System Admin", password: "Admin123*" },
  MANAGER: { email: "test-manager@scmayer.local", name: "Test Manager", password: "Manager123*" },
  WAREHOUSE_OPERATOR: { email: "test-warehouse@scmayer.local", name: "Test Warehouse", password: "Warehouse123*" },
  SALES_EXECUTIVE: { email: "test-sales@scmayer.local", name: "Test Sales", password: "Sales123*" },
};
