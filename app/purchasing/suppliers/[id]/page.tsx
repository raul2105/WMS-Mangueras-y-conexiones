...
import { firstErrorMessage } from "@/lib/schemas/wms";
import { z } from "zod";
...
export default async function SupplierDetailPage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {sp.ok && <div className="glass-card border border-green-500/30 text-green-200 text-sm">Producto vinculado correctamente.</div>}
